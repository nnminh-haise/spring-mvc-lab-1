...
- IntelliJ IDE Ultimate edition (must)
- Tomcat server
- JDK 17+
...
![Creating Java EE project using Jakarte EE](docs/reports/lab1/image-12.png)
...
![Choosing dependencies](docs/reports/lab1/image-1.png)

- Press Next to create project

![alt text](docs/reports/lab1/image-13.png)
...
![Build hello world project](docs/reports/lab1/image-14.png)

- IntelliJ will use your default browser to open the web

![The webapp result](docs/reports/lab1/image-15.png)

And inside the IntelliJ IDE

![Tomcat server running inside IntelliJ](docs/reports/lab1/image-16.png)
...
![All Spring MVC libraries I'll use](docs/reports/lab1/image-17.png)
...
![Project state](docs/reports/lab1/image-18.png)

Then run the project at `/welcome.htm`:

![Result to "welcome.htm"](docs/reports/lab1/image-19.png)
...
![alt text](docs/reports/lab1/image-20.png)

And the result when you run the server at `/student/form.htm`:

![alt text](docs/reports/lab1/image-21.png)
...
![alt text](docs/reports/lab1/image-22.png)

![alt text](docs/reports/lab1/image-23.png)
